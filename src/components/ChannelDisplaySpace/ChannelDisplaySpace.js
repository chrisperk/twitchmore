          ...
          {props.activeChannels.map(activeChannel => {
            ...
            if (!activeChannel.channel) {
              return (
                <Col key={activeChannel._id} className="channel-display" sm={12}>
                  <iframe
                    src={`https://player.twitch.tv/?channel=${activeChannel.display_name}&muted=true&autoplay=true&playsinline=true`}
                    height={props.areSearchResultsDisplayed ?
                      window.innerHeight - 186 + 'px' :
                      window.innerHeight - 50 + 'px'}
                    width="100%"
        ...
        >
          {
            props.activeChannels[0].channel ?
              <Col className="channel-display" sm={12} key={props.activeChannels[0]._id}>
                <iframe
                  src={`https://player.twitch.tv/?channel=${props.activeChannels[0].channel.display_name}&muted=true&autoplay=true&playsinline=true`}
                  height={props.areSearchResultsDisplayed ?
                    window.innerHeight / 2 - 93 + 'px' :
                    window.innerHeight / 2 - 26 + 'px'}
                  width="100%"
                ...
                />
                <div className="close-channel-button" onClick={event =>
                  props.handleUnselectChannel(props.activeChannels[0], props.activeChannels, event)
                }>
                  <i className="fa fa-times" />
                </div>
              </Col> :
              <Col className="channel-display" sm={12} key={props.activeChannels[0]._id}>
                <iframe
                  src={`https://player.twitch.tv/?channel=${props.activeChannels[0].display_name}&muted=true&autoplay=true&playsinline=true`}
                  height={props.areSearchResultsDisplayed ?
                    window.innerHeight / 2 - 93 + 'px' :
                    window.innerHeight / 2 - 26 + 'px'}
                  width="100%"
          ...
          }
          {
            props.activeChannels[1].channel ?
              <Col className="channel-display" sm={6} key={props.activeChannels[1]._id}>
                <iframe
                  src={`https://player.twitch.tv/?channel=${props.activeChannels[1].channel.display_name}&muted=true&autoplay=true&playsinline=true`}
                  height={props.areSearchResultsDisplayed ?
                    window.innerHeight / 2 - 93 + 'px' :
                    window.innerHeight / 2 - 26 + 'px'}
                  width="100%"
                ...
                />
                <div className="close-channel-button" onClick={event =>
                  props.handleUnselectChannel(props.activeChannels[1], props.activeChannels, event)
                }>
                  <i className="fa fa-times" />
                </div>
              </Col> :
              <Col className="channel-display" sm={6} key={props.activeChannels[1]._id}>
                <iframe
                  src={`https://player.twitch.tv/?channel=${props.activeChannels[1].display_name}&muted=true&autoplay=true&playsinline=true`}
                  height={props.areSearchResultsDisplayed ?
                    window.innerHeight / 2 - 93 + 'px' :
                    window.innerHeight / 2 - 26 + 'px'}
                  width="100%"
          ...
          }
          {
            props.activeChannels[2].channel ?
              <Col className="channel-display" sm={6} key={props.activeChannels[2]._id}>
                <iframe
                  src={`https://player.twitch.tv/?channel=${props.activeChannels[2].channel.display_name}&muted=true&autoplay=true&playsinline=true`}
                  height={props.areSearchResultsDisplayed ?
                    window.innerHeight / 2 - 93 + 'px' :
                    window.innerHeight / 2 - 26 + 'px'}
                  width="100%"
                ...
                />
                <div className="close-channel-button" onClick={event =>
                  props.handleUnselectChannel(props.activeChannels[2], props.activeChannels, event)
                }>
                  <i className="fa fa-times" />
                </div>
              </Col> :
